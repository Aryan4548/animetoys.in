// Google's official four-color "G" mark, per their brand guidelines for
// "Continue with Google" buttons. Shared between the login and register
// pages rather than duplicated inline in both.
